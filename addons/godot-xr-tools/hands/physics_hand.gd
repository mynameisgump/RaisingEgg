...
@export var current_hand : String = ""
...
static func find_instance(node : Node) -> XRToolsPhysicsHand:
	return XRTools.find_xr_child(
		XRHelpers.get_xr_controller(node),
		"*",
		"XRToolsPhysicsHand") as XRToolsPhysicsHand


## This function searches from the specified node for the left controller
## [XRToolsHand] assuming the node is a sibling of the [XROrigin3D].
static func find_left(node : Node) -> XRToolsPhysicsHand:
	return XRTools.find_xr_child(
...
## [XRToolsHand] assuming the node is a sibling of the [XROrigin3D].
static func find_right(node : Node) -> XRToolsPhysicsHand:
	return XRTools.find_xr_child(
...
func is_xr_class(name : String) -> bool:
	return name == "XRToolsPhysicsHand" 
